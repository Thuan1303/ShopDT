...
<nav class="navbar navbar-expand-lg navbar-light navMenu py-0 fade-In" style="background-color: #fab1a0;">
    ...
    <div id="search-form">
        ...
        <form action="search" method="post">
            ...
            <div class="w-100">
                ...
                <input type="text" class="search-input w-100" name="search" value="" placeholder="điện thoại, máy tính bảng,..." />
