            ...
            <div class="card col-lg-3 col-md-4 col-sm-12 p-0 mx-1 my-2 float-left border-0 rounded">
                ...
                <div class="w-100 col-12 d-inline-block mt-3" style="overflow:hidden;max-height:30px;">
                    <ul class="d-flex flex-row flex-wrap">
                        ...
                        if(count($data) > 1){
                        foreach($data as $img){
                        echo '<li class="rounded-circle mr-2 more-img" data-id="'.$product->id.'" data-src="'.$img->image.'" style="background-image:url('.$img->image.');"></li>';
                        $i++;
                        }
                        }
                        }
...
<div class="carousel-inner mt-5">
    <div class="carousel-item active">
        <img class="w-100" src="https://images.pexels.com/photos/296115/pexels-photo-296115.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" style="object-fit:cover;height:65vh;" />
    </div>
</div>
@endsection
@section('title')
