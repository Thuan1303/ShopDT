    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <button class="btn btn-danger rounded-0" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$u->id}}">Xóa <i class="far fa-trash-alt"></i></button>
        </td>
        @else
        <td></td>
        @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href='admin/dashboard/delete-user/{{$u->id}}'><button type="button" class="btn btn-danger">Xóa
                  ngay</button></a>
            </div>
          </div>
        </div>
