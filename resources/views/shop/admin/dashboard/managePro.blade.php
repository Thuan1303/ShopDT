...
<div class="container-fluid padding p-0">
	...
	@endif
	<div class="col-lg-3 col-md-6 col-sm-12 d-inline-block border item-option p-2 text-center"><a href="admin/dashboard/them-san-pham"><i class="fas fa-clipboard-list fa-7x text-info w-100 mb-2"></i>Thêm sản
			phẩm</a></div>
	...
	<form method="get">
		...
		<div class="form-group">
			...
			<input id="_product" type="text" class="form-control" name="_product" value="" placeholder="điện thoại, lap top..." />
		</div>
	</form>
		...
		<tbody id="__product">
			...
			<tr>
				...
				<td>
					...
					<button class="btn btn-danger rounded-0" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$product->id}}">Xóa <i class="far fa-trash-alt"></i></button>
				</td>
