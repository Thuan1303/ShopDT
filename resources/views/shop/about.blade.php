...
<div class="container-fluid padding text-center p-2 text-light">
	<div class="profile col-lg-4 col-md-12 col-sm-12 my-2 float-left">
		...
		<div class="col-12">
			<h2 class="card-title-info ml-4">Trần Ngọc Duy</h2>
	...
	<div class="profile col-lg-4 col-md-12 col-sm-12 my-2 float-left">
		...
		<div class="col-12">
			<h2 class="card-title-info ml-4">Ngô Như Thuần</h2>
			<p class="card-text">Nhà phát triển - Developer</p>
		</div>
	</div>
	<div class="profile col-lg-4 col-md-12 col-sm-12 my-2 float-left">
		<div class="background">
		...
		<div class="col-12">
			<h2 class="card-title-info ml-4">Nguyễn Hữu Thiện</h2>
...
<meta property="og:keyword" content="tatshop, tat, tat shop" />
