                ...
                <div class="col-xs-12">
                    <div class="invoice-wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 d-flex flex-row justify-content-between">
                                    <div class="invoice-top-right">
                                        ...
                                        <h6 class="our-address">Phường 11, <br>Quận Bình Thạnh <br>Thành phố Hồ
                                            Chí Minh</h6>
                                        <h5>
                                            <?php
                                    ...
                                    <div class="logo-wrapper">
                                        <img src="{{asset('')}}image/brand_logo.png" class="img-responsive pull-right logo" width="80px" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="invoice-bottom">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h2 class="title">HÓA ĐƠN <span class="badge bg-{{getColor($bill->stt)}}">{{getStt($bill->stt)}}</span></h2>
                                </div>
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="invoice-bottom-left">
                                        ...
                                        <h4 style="font-weight:bold">TSI
                                            {{$date->format('i').$date->format('Y').$date->format('m').$bill->id}}
                                        </h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="invoice-bottom-right">
                                        <table class="table fs-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$payment->qty}}</td>
                                                    <td><img src="{{$payment->product->thumbnail}}" alt="product" width="60px"></td>
                                        ...
                                        <ul class="fs-4">
                                            <li>Tên người nhận: Ngô Như Thuần</li>
                                            <li>Số điện thoại: 0935253269</li>
                                        ...
                                        <ul class="fs-4">
                                            <li>Chủ tài khoản: Ngô Như Thuần</li>
                                            <li>Số TK: 580001283757</li>
                                            <li>Chi nhánh: Ngân hàng BIDV - Chi nhánh Hóc môn</li>
                                            <li>Nội dung chuyển khoản: Mã hóa đơn + Họ tên</li>
                                            <li><img src="{{asset('')}}image/qr/bidv-qr.png" alt="bank" width="200px" /></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-sm-4">
                                    <h6 class="text-center">ngothuan130301@gmail.com</h6>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="text-right">+84 935 253 269</h6>
                                </div>
                            </div>
